...
export function newChatModal(): string {
  return `
...
export function profileEditModal(): string {
...
export function userProfileModal(user: NonNullable<typeof state.activeChat>['other']): string {
